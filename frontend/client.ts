 ...
 */
import { createAccount as api_finance_create_account_createAccount } from "~backend/finance/create_account";
...
import { listAccounts as api_finance_list_accounts_listAccounts } from "~backend/finance/list_accounts";
...
export namespace finance {
    ...
    export class ServiceClient {
         ...
         */
        public async createAccount(params: RequestType<typeof api_finance_create_account_createAccount>): Promise<ResponseType<typeof api_finance_create_account_createAccount>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/accounts`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_finance_create_account_createAccount>
        }
        ...
        public async createBudget(params: RequestType<typeof api_finance_create_budget_createBudget>): Promise<ResponseType<typeof api_finance_create_budget_createBudget>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/budgets`, {method: "POST", body: JSON.stringify(params)})
        ...
        public async createCategory(params: RequestType<typeof api_finance_create_category_createCategory>): Promise<ResponseType<typeof api_finance_create_category_createCategory>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/categories`, {method: "POST", body: JSON.stringify(params)})
        ...
        public async createTransaction(params: RequestType<typeof api_finance_create_transaction_createTransaction>): Promise<ResponseType<typeof api_finance_create_transaction_createTransaction>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/transactions`, {method: "POST", body: JSON.stringify(params)})
         ...
         */
        public async listAccounts(): Promise<ResponseType<typeof api_finance_list_accounts_listAccounts>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/accounts`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_finance_list_accounts_listAccounts>
        }

        /**
         * Retrieves finance budgets with optional period filtering.
         */
        public async listBudgets(params: RequestType<typeof api_finance_list_budgets_listBudgets>): Promise<ResponseType<typeof api_finance_list_budgets_listBudgets>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/budgets`, {query, method: "GET", body: undefined})
         ...
         */
        public async listCategories(params: RequestType<typeof api_finance_list_categories_listCategories>): Promise<ResponseType<typeof api_finance_list_categories_listCategories>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/categories`, {query, method: "GET", body: undefined})
        ...
        public async listTransactions(params: RequestType<typeof api_finance_list_transactions_listTransactions>): Promise<ResponseType<typeof api_finance_list_transactions_listTransactions>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/finance/transactions`, {query, method: "GET", body: undefined})
...
import { createTaskList as api_tasks_create_task_list_createTaskList } from "~backend/tasks/create_task_list";
import { createTaskTag as api_tasks_create_task_tag_createTaskTag } from "~backend/tasks/create_task_tag";
import { deleteTask as api_tasks_delete_task_deleteTask } from "~backend/tasks/delete_task";
import { deleteTaskList as api_tasks_delete_task_list_deleteTaskList } from "~backend/tasks/delete_task_list";
import { listTaskLists as api_tasks_list_task_lists_listTaskLists } from "~backend/tasks/list_task_lists";
import { listTaskTags as api_tasks_list_task_tags_listTaskTags } from "~backend/tasks/list_task_tags";
...
import { updateTaskList as api_tasks_update_task_list_updateTaskList } from "~backend/tasks/update_task_list";
...
export namespace tasks {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.createTaskTag = this.createTaskTag.bind(this)
            this.deleteTask = this.deleteTask.bind(this)
            this.deleteTaskList = this.deleteTaskList.bind(this)
            this.listTaskLists = this.listTaskLists.bind(this)
            this.listTaskTags = this.listTaskTags.bind(this)
         ...
         */
        public async createTaskList(params: RequestType<typeof api_tasks_create_task_list_createTaskList>): Promise<ResponseType<typeof api_tasks_create_task_list_createTaskList>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/task-lists`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_tasks_create_task_list_createTaskList>
        }

        /**
         * Creates a new task tag.
         */
        public async createTaskTag(params: RequestType<typeof api_tasks_create_task_tag_createTaskTag>): Promise<ResponseType<typeof api_tasks_create_task_tag_createTaskTag>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/task-tags`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_tasks_create_task_tag_createTaskTag>
        }
         ...
         */
        public async deleteTaskList(params: { id: string }): Promise<void> {
            await this.baseClient.callTypedAPI(`/task-lists/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }

        /**
         * Retrieves all task lists for the authenticated user.
         */
        public async listTaskLists(): Promise<ResponseType<typeof api_tasks_list_task_lists_listTaskLists>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/task-lists`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_tasks_list_task_lists_listTaskLists>
        }

        /**
         * Retrieves all task tags for the authenticated user.
         */
        public async listTaskTags(): Promise<ResponseType<typeof api_tasks_list_task_tags_listTaskTags>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/task-tags`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_tasks_list_task_tags_listTaskTags>
        }
         ...
         */
        public async updateTaskList(params: RequestType<typeof api_tasks_update_task_list_updateTaskList>): Promise<ResponseType<typeof api_tasks_update_task_list_updateTaskList>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
                color:       params.color,
                description: params.description,
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/task-lists/${encodeURIComponent(params.id)}`, {method: "PUT", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_tasks_update_task_list_updateTaskList>
        }
    }
}
