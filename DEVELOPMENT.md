...
```bash
git remote add encore encore://saas-task-finance-manager-52v2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/saas-task-finance-manager-52v2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/saas-task-finance-manager-52v2/settings/integrations/github)
